...
void Lesson14::onEnter() {
	glEnable(GL_LIGHT0);
    glEnable(GL_LIGHTING);
	BuildFont();
}

void Lesson14::onUpdate(float deltaTime) {
}

void Lesson14::onRenderUI() {
...
void Lesson14::KillFont() {
    glDeleteLists(base, 256);               // Delete All 256 Characters
}

void Lesson14::glPrint(const char *fmt, ...) {
